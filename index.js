...
let firstWeekDailyAverage = firstWeekSales.map((element, index) => element /
  firstWeekCustomers[index]);
let labeled = firstWeekDailyAverage.map((element, index) => daysOfTheWeek[
  index] + " " + element.toFixed(2));
